...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * onClick method called when Add button is clicked
     */
    ...
    /**
     * onclick method called when Sub button is clicked
     */
    ...
    /**
     * onClcik method is called when onMul button is clicked
     */
    ...
    private void compute(Calculator.Operator operator){
        ...
        try{
            ...
            mResultTextView.setText(getText(R.string.computationError));
            return;
